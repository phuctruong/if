...
SURVEY_PRODUCTS: tuple[SurveyProduct, ...] = (
    ...
    # --- replication-essential products added 2026-06-12 (referee loop iter 3):
    # previously manual steps in REPLICATION.md; now one command stages
    # everything the prediction scripts + replications need.
    SurveyProduct(
        product_id="sparc_lelli2016_table",
        survey="sparc",
        tags=("minimal", "sparc"),
        description="SPARC master table (Lelli/McGaugh/Schombert 2016)",
        url="https://astroweb.cwru.edu/SPARC/SPARC_Lelli2016c.mrt",
        relative_path=Path("sparc/SPARC_Lelli2016c.mrt"),
        expected_bytes=28_259,
        source_page="https://astroweb.cwru.edu/SPARC/",
    ),
    SurveyProduct(
        product_id="sparc_rotmod_ltg_zip",
        survey="sparc",
        tags=("minimal", "sparc"),
        description="SPARC Rotmod_LTG rotation curves (unzip to sparc/Rotmod_LTG/)",
        url="https://astroweb.cwru.edu/SPARC/Rotmod_LTG.zip",
        relative_path=Path("sparc/Rotmod_LTG.zip"),
        expected_bytes=110_737,
        source_page="https://astroweb.cwru.edu/SPARC/",
    ),
    SurveyProduct(
        product_id="pantheon_plus_distances",
        survey="pantheon",
        tags=("minimal", "pantheon"),
        description="Pantheon+SH0ES distances (1701 SNe)",
        url="https://raw.githubusercontent.com/PantheonPlusSH0ES/DataRelease/main/Pantheon%2B_Data/4_DISTANCES_AND_COVAR/Pantheon%2BSH0ES.dat",
        relative_path=Path("pantheon_plus/Pantheon+_Data/4_DISTANCES_AND_COVAR/Pantheon+SH0ES.dat"),
        expected_bytes=579_283,
        source_page="https://github.com/PantheonPlusSH0ES/DataRelease",
    ),
    SurveyProduct(
        product_id="pantheon_plus_cov_statsys",
        survey="pantheon",
        tags=("minimal", "pantheon"),
        description="Pantheon+SH0ES STAT+SYS covariance",
        ...
        relative_path=Path("pantheon_plus/Pantheon+_Data/4_DISTANCES_AND_COVAR/Pantheon+SH0ES_STAT+SYS.cov"),
        expected_bytes=33_284_960,
        source_page="https://github.com/PantheonPlusSH0ES/DataRelease",
    ),
    SurveyProduct(
        product_id="pantheon_plus_cov_statonly",
        survey="pantheon",
        tags=("minimal", "pantheon"),
        description="Pantheon+SH0ES STATONLY covariance (absence broke 2 tests, 2026-06-12 pass)",
        url="https://raw.githubusercontent.com/PantheonPlusSH0ES/DataRelease/main/Pantheon%2B_Data/4_DISTANCES_AND_COVAR/Pantheon%2BSH0ES_STATONLY.cov",
        relative_path=Path("pantheon_plus/Pantheon+_Data/4_DISTANCES_AND_COVAR/Pantheon+SH0ES_STATONLY.cov"),
        expected_bytes=31_827_416,
        source_page="https://github.com/PantheonPlusSH0ES/DataRelease",
    ),
    SurveyProduct(
        product_id="boss_cuesta2016_measurements",
        survey="boss",
        tags=("minimal", "boss-papers"),
        description="Cuesta 2016 CMASS+LOWZ DR12 consensus xi(r) (untar after download)",
        url="https://data.sdss.org/sas/dr12/boss/papers/clustering/Cuesta_2016_CMASSDR12_LOWZDR12_measurements.tar.gz",
        relative_path=Path("boss_published_xi/Cuesta_2016_CMASSDR12_LOWZDR12_measurements.tar.gz"),
        expected_bytes=69_551,
        source_page="https://data.sdss.org/sas/dr12/boss/papers/clustering/",
    ),
    SurveyProduct(
        product_id="desi_dr1_lss_lrg_sgc_random0",
        survey="desi",
        tags=("desi-lss", "desi-randoms"),
        description="DESI DR1 LSS LRG SGC random catalog 0 (end-to-end xi replication)",
        url=f"{DESI_DR1_LSS}LRG_SGC_0_clustering.ran.fits",
        relative_path=Path("desi_dr1/lss/LRG_SGC_0_clustering.ran.fits"),
        expected_bytes=520_781_760,
        source_page=DESI_DR1_LSS,
    ),
)
